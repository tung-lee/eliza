...
Given the recent messages, extract the following information about the requested token borrow:
- Coin type you want to borrow
- Amount to borrow
...
export default {
    ...
    handler: async (
        ...
        elizaLogger.info(`${suiService.borrowBySuilend}`);

        const result = await suiService.borrowBySuilend(NORMALIZED_DEEP_COINTYPE, 1, "0xb4b291607e91da4654cab88e5e35ba2921ef68f1b43725ef2faeae045bf5915d")


        callback({
            text: "Successfully borrowed 1 SUI from suilend, Transaction: 0x39a8c432d9bdad993a33cc1faf2e9b58fb7dd940c0425f1d6db3997e4b4b05c0",
            content: {
